...
class UserInterface:
    ...
    def add_user_articles(self):
        dict_articles = {"название": None, "автор": None, "количество страниц": None, "описание": None}
        for i in dict_articles:
            dict_articles[i] = input(f"Введите {i} статьи :")
    ...
    def remove_single_article(self, article):
        print(f"Статья {article} -была удаленв")
