class Account:
    ...
    def get_deposit(self, get_money):
        if get_money <= self.summ_py:
            self.summ_py = self.summ_py - get_money
    ...
    def add_persent(self):
        self.summ_py = self.summ_py + (self.summ_py * self.pesent)
        print("Процент начислен!!!")
        self.print_balance()

    def add_money(self, money):
        self.summ_py = self.summ_py + money
